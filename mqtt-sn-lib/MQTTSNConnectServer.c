...
/**
  ...
  * @return error code.  1 is success, 0 is failure
  */
int MQTTSNDeserialize_willtopic1(int *willQoS, unsigned char *willRetain, MQTTSNString* willTopic, unsigned char* buf, size_t len,
...
/**
  ...
  * @return error code.  1 is success, 0 is failure
  */
int MQTTSNDeserialize_willtopic(int *willQoS, unsigned char *willRetain, MQTTSNString* willTopic, unsigned char* buf, size_t len)
{
...
/**
  ...
  * @return error code.  1 is success, 0 is failure
  */
int MQTTSNDeserialize_willtopicupd(int *willQoS, unsigned char *willRetain, MQTTSNString* willTopic, unsigned char* buf, size_t len)
{
...
/**
  ...
  * @return error code.  1 is success, 0 is failure
  */
int MQTTSNDeserialize_willmsg1(MQTTSNString* willMsg, unsigned char* buf, size_t len, enum MQTTSN_msgTypes packet_type)
{
	unsigned char* curdata = buf;
	unsigned char* enddata = &buf[len];
	int rc = 0;
...
/**
  ...
  * @return error code.  1 is success, 0 is failure
  */
int MQTTSNDeserialize_willmsg(MQTTSNString* willMsg, unsigned char* buf, size_t len)
{
...
/**
  ...
  * @return error code.  1 is success, 0 is failure
  */
int MQTTSNDeserialize_willmsgupd(MQTTSNString* willMsg, unsigned char* buf, size_t len)
{
