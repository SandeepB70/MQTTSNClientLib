...
int MQTTSNDeserialize_subscribe(unsigned char* dup, int* qos, unsigned short* packetid,
        MQTTSN_topicid* topicFilter, unsigned char* buf, size_t buflen);

int MQTTSNSerialize_suback(unsigned char* buf, size_t buflen, int qos, unsigned short topicid, unsigned short packetid,
